        ...
        if(mysqli_num_rows($query)){
            while($result=mysqli_fetch_assoc($query)){
                ...
                <tr>
                    ...
                    <td>
                        <a href="edit.php?id_jenis=<?php echo $result['id_jenis']; ?>" class="btn btn-outline-info">Edit</a>
                        <a href="hapus.php?id_jenis=<?php echo $result['id_jenis']; ?>" class="btn btn-outline-danger" onclick="return confirm('bneran mau apus?')">Hapus</a>
                    </td>
                </tr>
            <?php
            }
